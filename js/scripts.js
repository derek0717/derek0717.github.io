...
/**/
	...
	var effects=[
		...
		["防御系",
			...
			["防御","+3%","+5%","+7%","+10%"],
			["被ダメージ","-3%","-5%","-10%"],
			["状態無効","","感電無効","燃焼無効","暗闇無効","封印無効","衰弱無効","スロウ無効","気絶無効","毒無効","凍結無効"]
		],
		["補助系",
			["SP","+3%","+5%","+7%","+10%"],
			["SP消費","-3%","-5%","-10%"],
		...
		["独特スキル","","茶熊種へのダメージ+30%","パーティのヒーロータイプ数ｘ被ダメージ-3%","シールド耐久値+30%","カウンタースラッシュ・カウンターエッジの威力+30%","水属性ダメージ+5%","チャージ時アクションスキル強化+5%","チャージ時間-5%","敵撃破5体毎にHP20回復","敵撃破5体毎にSP5回復","通常攻撃の与えるダメージ＋15％","~二刀流~星爆気流斬"]
	];
